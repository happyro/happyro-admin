...
final class ItemGrantServiceTest extends TestCase
{
    ...
    public function test_mail_grant_validates_catalog_and_audits(): void
    {
        ...
        $result = (new ItemGrantService($items, $grants, $audit))->mail(['item_id' => 670, 'char_id' => 3, 'amount' => 1, 'title' => 'Gift', 'message' => 'Hello', 'idempotency_key' => 'grant-1'], new User, new ClientContext(null, null));
    ...
    public function test_mail_grant_replays_the_same_request_without_sending_again(): void
    {
        ...
        $service = new ItemGrantService($items, $grants, $audit);
