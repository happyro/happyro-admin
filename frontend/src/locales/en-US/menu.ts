export default {
  'menu.gameData': 'Game data',
  'menu.gameData.items': 'Item catalog',
  'menu.gameData.monsters': 'Monster catalog',
  'menu.gameData.npcs': 'NPC search',
  'menu.gameData.maps': 'Map search',
  'menu.operations': 'Operations',
  'menu.operations.itemGrants': 'Item grants',
  'menu.operations.zenyGrants': 'Zeny grants',
  ...
  'menu.settings.gameSettingHistory': 'Configuration history',
